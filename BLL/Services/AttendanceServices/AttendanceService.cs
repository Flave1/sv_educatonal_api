...
namespace SMP.BLL.Services.AttendanceServices
{
    public class AttendanceService: IAttendanceService
    {
        ...
        public AttendanceService(DataContext context, IPaginationService paginationService, IHttpContextAccessor accessor, ITermService termService, ILoggerService logger)
        {
