...
namespace API.Data.Migrations
{
    ...
    [Migration("20220221102140_sesionClasssasas")]
    partial class sesionClasssasas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.StudentInformation.StudentContact", b =>
                {
                    b.HasOne("DAL.ClassEntities.SessionClass", null)
                        .WithMany("Students")
                        .HasForeignKey("SessionClassId");

                    b.HasOne("DAL.ClassEntities.SessionClass", "Class")
                        .WithOne("ClassCaptain")
                        .HasForeignKey("DAL.StudentInformation.StudentContact", "StudentContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
