...
namespace SMP.DAL.Migrations
{
    ...
    [Migration("20220816094049_timetable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMP.DAL.Models.Timetable.ClassTimeTableDayActivity", b =>
                {
                    b.Property<Guid>("ClassTimeTableDayActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ClassTimeTableDayTimeId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ClassTimeTableDayActivityId");

                    b.HasIndex("ClassTimeTableDayTimeId");

                    b.ToTable("ClassTimeTableDayActivity");
                });

            modelBuilder.Entity("SMP.DAL.Models.Timetable.ClassTimeTableDayTime", b =>
                {
                    b.Property<Guid>("ClassTimeTableDayTimeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ClassTimeTableDayTimeId");

                    b.HasIndex("ClassTimeTableDayId");

                    b.ToTable("ClassTimeTableDayTime");
                });
            ...
            modelBuilder.Entity("SMP.DAL.Models.Timetable.ClassTimeTableDayActivity", b =>
                {
                    b.HasOne("SMP.DAL.Models.Timetable.ClassTimeTableDayTime", "Time")
                        .WithMany("Activities")
                        .HasForeignKey("ClassTimeTableDayTimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
